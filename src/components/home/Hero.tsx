          ...
          <div className="group flex flex-col items-center space-y-8">
            <div className="space-y-4">
              <h1
                ...
                className="animate-fade-in-up bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text font-headline text-4xl font-bold leading-tight tracking-tighter text-transparent sm:text-5xl md:text-6xl lg:text-7xl whitespace-nowrap"
              >
